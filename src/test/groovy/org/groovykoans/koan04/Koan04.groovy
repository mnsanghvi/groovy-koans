...
class Koan04 extends GroovyTestCase {
    ...
    void test02_MoreClosureIntro() {
        ...
        // ------------ START EDITING HERE ----------------------
        assertEquals('They are not same', groovyResult, javaResult)
        // ------------ STOP EDITING HERE  ----------------------
        ...
        // ------------ START EDITING HERE ----------------------
        new File("$prefix/exercise-solved.txt").filterLine(filteredResult, {String line->!line.startsWith("#")})
        // ------------ STOP EDITING HERE  ----------------------
